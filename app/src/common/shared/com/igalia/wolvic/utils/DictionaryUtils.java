...
public class DictionaryUtils {
     ...
     * @return true if the dictionary is external, false otherwise.
     */
    public static boolean isExternalDictionary(@NonNull Context context, @NonNull String lang, @NonNull String versionName) {
        return getExternalDictionaryByLang(context, lang, versionName) != null;
    }
